...
internal record QuestDto(int Id,string Title,bool IsMainQuest,int NextQuestId,List<QuestStageDto> Stages)
{
    /// <summary>
    ...
    internal Quest ToQuest() {
        ...
        return new Quest(Id, Title,IsMainQuest,NextQuestId,stagesList.ToArray());
    }
}